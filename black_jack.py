...
def yet(update, context):
    ...
    if sum(count_points_user) < 21:
        ...
        context.bot.send_message(update.effective_chat.id, f"Ты не можешь взять больше! у вас {sum(count_points_user)}")
